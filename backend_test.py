...
class BionicV8EcologicalTester:
    def __init__(self, base_url: str = "https://heatmap-lite.preview.emergentagent.com"):
...
def main():
    ...
    backend_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://heatmap-lite.preview.emergentagent.com')
