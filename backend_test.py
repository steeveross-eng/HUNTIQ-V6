...
class BionicV8EcologicalTester:
    def __init__(self, base_url: str = "https://alimentation-v2-fix.preview.emergentagent.com"):
...
def main():
    ...
    backend_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://alimentation-v2-fix.preview.emergentagent.com')
