...
class BionicV8EcologicalTester:
    def __init__(self, base_url: str = "https://corridor-analysis.preview.emergentagent.com"):
...
def main():
    ...
    backend_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://corridor-analysis.preview.emergentagent.com')
